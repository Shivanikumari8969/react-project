        ...
        <div className='max-w-[1520px] m-auto text-white px-4 bg-[#24262b]'>
           ...
           <div className='lg:col-span-2 my-4'>
            <h1> Need advice on how to improve your flow? </h1>
             <p>Sign Up to join our newsletter and stay up to date with the latest trends   </p>
           </div>
           <div className='my-4'>
             ...
             <p>We respect your privacy and will not share your email with anyone, Read{" "}
             <span className='text-[#00df9a]'>Privacy Policy</span>
             </p>
           </div>
           <hr className='my-4 bg-gray-700 border-1 grid:bg-gray-700'/>
            </div>
        </div>
    )
}
